...
/// @title Pallas Elliptic Curve Interface
/// @notice This interface defines the functions for interacting with the Pallas curve
...
interface IPallas {
  ...
  /// @dev Returns generator point of the Pallas curve in affine coordinates.
  function affineGenerator() external pure returns (AffinePoint memory g);

  /// @dev Returns generator point of the Pallas curve in projective coordinates.
  ...
  /// @dev Returns the negation of a scalar on the Pallas Curve.
  ...
  /// @dev Doubles a projective point on the Pallas Curve.
  ...
  /// @dev Adds two affine points on the Pallas Curve.
  ...
  /// @dev Adds two projective points on the Pallas Curve.
  ...
  /// @dev Multiplies an affine point by a scalar on the Pallas Curve.
  ...
  /// @dev Multiplies a projective point by a scalar on the Pallas Curve.
  ...
  /// @dev Checks if a point is on the Pallas Curve.
  /// @param p The affine point to check.
