	...
	tests = map[string]testutils.PrecompileTest{
		...
		"insufficient gas for doubleAffine should fail": {
			...
			InputFn: func(t testing.TB) []byte {
				...
				var testInput IVestaAffinePoint
		...
		"insufficient gas for doubleProjective should fail": {
			...
			InputFn: func(t testing.TB) []byte {
				// CUSTOM CODE STARTS HERE
				// set test input to a value here
				var testInput IVestaProjectivePoint
...
// TestVestaRun tests the Run function of the precompile contract.
func TestVestaRun(t *testing.T) {
	// Run tests.
...
// func BenchmarkVesta(b *testing.B) {
// 	// Benchmark tests.
// 	for name, test := range tests {
